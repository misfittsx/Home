...
u("4hJWI", function (t, e) {
  ...
  u("jxfTi", function (e, r) {
     ...
     */ var s,
      ...
      tx = function (t) {
        var e,
          r,
          i = t[0];
        if ((N(i) || q(i) || (t = [t]), !(e = (i._gsap || {}).harness))) {
      ...
      t1 = function (t, e, r, i) {
        ...
        if (
          ...
          if (!t._initted && t$(t, e, i, r, f)) return;
          for (
            a = t._zTime,
              t._zTime = e || (r ? 1e-8 : 0),
              r || (r = e && !a),
      ...
      t2 = function (t, e, r, i) {
        ...
        return (
          ...
          (t._dur = s),
          (t._tDur = n ? (n < 0 ? 1e10 : tE(s * (n + 1) + t._rDelay * n)) : s),
      ...
      t3 = function (t) {
        return t instanceof eN ? tU(t) : t2(t, t._dur);
      },
      ...
      t4 = function (t, e, r) {
        ...
        if ((s && (o.duration = e[1]), (o.parent = r), t)) {
          ...
          (o.immediateRender = Q(i.immediateRender)),
      ...
      ex = function (t, e, r) {
        ...
        if (!p) {
          if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), ev[t]))
            p = ev[t];
          else if ("#" === t.charAt(0)) {
            if (
              (t.length < 6 &&
      ...
      eT = function (t, e, r) {
        ...
        if (
          ...
          for (a = (n = t.replace(eb, "1").split(Z)).length - 1; f < a; f++)
            o +=
              n[f] +
              (~i.indexOf(f)
                ? u.shift() || h + "0,0,0,0)"
        ...
        return (
          ...
          (e.startTime = function (t) {
            if (arguments.length) {
              ...
              return (
                e && (e._sort || !this.parent) && tJ(e, this, t - this._delay),
                this
              );
            }
            return this._start;
    ...
    var eN = (function (t) {
      function e(e, r) {
        ...
        return (
          ...
          e.paused && n.paused(!0),
          e.scrollTrigger && tZ(i(n), e.scrollTrigger),
          n
        );
      }
      n(e, t);
      ...
      return (
        ...
        (r.staggerFrom = function (t, e, r, i, n, s, a) {
          return (
            (r.runBackwards = 1),
            (tI(r).immediateRender = Q(r.immediateRender)),
        ...
        (r.staggerFromTo = function (t, e, r, i, n, s, a, o) {
          return (
            (i.startAt = r),
            (tI(i).immediateRender = Q(i.immediateRender)),
        ...
        (r.add = function (t, e) {
          var r = this;
          if ((U(e) || (e = t6(this, e, t)), !(t instanceof ej))) {
            if (G(t))
              return (
                t.forEach(function (t) {
                  return r.add(t, e);
        ...
        (r.addPause = function (t, e, r) {
          ...
          return (
            (i.data = "isPause"), (this._hasPause = 1), tJ(this, i, t6(this, t))
          );
        }),
    ...
    tD(eN.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
    var eQ,
      eY,
      eX,
      eW,
      ...
      eZ = function (t, e, r, i, n, s, a, o, u, h) {
        ...
        if (
          ...
          return isNaN(c * i) || "" === i
            ? (l || e in t || ts(e, i),
              eJ.call(this, t, e, c, i, p, o || P.stringFilter, u))
            : ((f = new rl(
                this._pt,
                t,
                e,
      ...
      e$ = function (t, e, r, i, n) {
        if (
          (q(t) && (t = e3(t, n, e, r, i)),
          !N(t) || (t.style && t.nodeType) || G(t) || W(t))
        )
      ...
      eK = function (t, e, r, i, n, s) {
        ...
        if (
          ...
          !1 !==
            (a = new t_[t]()).init(
              n,
              a.rawVars ? e[t] : e$(e[t], i, n, s, r),
              r,
              i,
              s
            ) &&
          ((r._pt = o = new rl(r._pt, n, t, 0, 1, a.render, a, 0, a.priority)),
          r !== A)
        )
          for (
      ...
      e0 = function t(e, r, i) {
        ...
        if (
          ...
          for (
            s = 0, e._pt = e._ptCache = 0, k = (S && Q(k)) || (k && !S);
            s < z.length;
            s++
          ) {
            if (
              ...
              for (a in n)
                t_[a] && (c = eK(a, n, e, d, u, L))
                  ? c.priority && (h = 1)
                  : (p[a] = o =
                      eZ.call(e, u, a, "get", n[a], d, L, 0, g.stringFilter));
        ...
        if (
          ...
          if (
            ...
            if (G(T))
              ...
              for (l in ((h = {}), T))
                "ease" === l || "easeEach" === l || e2(l, T[l], h, T.easeEach);
              for (l in h)
                for (
                  u = 0,
          ...
          if (d) {
            if (
              ...
              if (
                ...
                i && !c && !e && !s && (ed(this, "onStart"), this._tTime !== m))
              )
                return this;
              for (n = this._pt; n; ) n.r(h, n.d), (n = n._next);
              (f &&
                f.render(t < 0 ? t : f._dur * f._ease(i / this._dur), e, r)) ||
                (this._startAt && (this._zTime = t)),
                this._onUpdate &&
                  !e &&
                  (_ && tN(this, t, e, r), ed(this, "onUpdate")),
                this._repeat &&
                  s !== o &&
                  this.vars.onRepeat &&
                  !e &&
                ...
                (m === this._tDur || !m) &&
                  this._tTime === m &&
                  (_ && !this._onUpdate && tN(this, t, !0, !0),
                  (t || !d) &&
                  ...
                  !e &&
                    !(_ && !c) &&
                    (m || c || u) &&
                    (ed(this, m === p ? "onComplete" : "onReverseComplete", !0),
                    this._prom &&
        ...
        (r.kill = function (t, e) {
          ...
          for (
            ...
            if (~l.indexOf(f[h]))
              ...
              a))
                (u = n && n[o]) &&
                  (("kill" in u.d && !0 !== u.d.kill(o)) || tV(this, u, "_pt"),
                  delete n[o]),
                  "all" !== s && (s[o] = 1);
    ...
    var e9 = function (t, e, r) {
      ...
      rr = function (t, e) {
        return q(t[e]) ? e7 : j(t[e]) && t.setAttribute ? re : e9;
      },
      ri = function (t, e) {
    ...
    tb(
      ...
      (tr.TimelineLite = tr.TimelineMax = eN),
      (b = new eN({
        sortChildren: !1,
        defaults: D,
      ...
      rw = {
        ...
        registerEffect: function (t) {
          ...
          (i || "").split(",").forEach(function (t) {
            ...
            s &&
              (eN.prototype[e] = function (t, r, i) {
                return this.add(tm[e](t, N(r) ? r : (i = r) && {}, this), i);
              });
        },
        ...
        exportRoot: function (t, e) {
          ...
          var r,
            ...
            n = new eN(t);
          for (
            n.smoothChildTiming = Q(t.smoothChildTiming),
              b.remove(n),
              n._dp = 0,
        ...
        utils: {
          ...
          interpolate: function t(e, r, i, n) {
            ...
            if (!s) {
              ...
              if (!u) {
                for (a in r) eZ.call(c, e, a, "get", r[a]);
                s = function (t) {
    ...
    (e4.version = eN.version = rE.version = "3.12.5"),
      (O = 1),
      Y() && eO(),
      eC.Power0,
      eC.Power1,
 ...
 */ var f,
  ...
  Y = function (t, e) {
    var r = { target: t, props: [], revert: Q, save: j };
    return (
  ...
  Z = function t(e) {
    ...
    if (
      (p.appendChild(i), i.appendChild(this), (this.style.display = "block"), e)
    )
      try {
        (r = this.getBBox()),
  ...
  tO = function (t, e, r) {
    ...
    for (n in (f.svg
      ...
      : ((s = getComputedStyle(r)[q]), (l[q] = e), (i = tv(r, 1)), (l[q] = s)),
    x))
      (s = f[n]) !== (a = i[n]) &&
...
var tC = {
  ...
  init: function (t, e, r, i, n) {
    ...
    e))
      if (
        "autoRound" !== l &&
        ((a = e[l]), !(y._plugins[l] && (0, y._checkPlugin)(l, e, r, i, t, n)))
      ) {
        if (
          ((h = typeof a),
          (f = tl[l]),
          ...
          if (
            (A && l in A
              ? ((s = "function" == typeof A[l] ? A[l].call(r, i, t, n) : A[l]),
                (0, y._isString)(s) &&
                  ~s.indexOf("random(") &&
...
const tS = document.querySelector(".frame"),
